...
if args.csv_file is None:
    csv_file = os.path.join('amazing_semantic_segmentation', 'roadcrack4', 'class_dict.csv')
else:
...
for i, name in enumerate(image_names):
    ...
    prediction = net(image, training=False)
    ...
    prediction.save(os.path.join(paths['prediction_path'], name + '.png'), 'PNG')
